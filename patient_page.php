			    ...
			    <div class="col-md-9 col-sm-8 col-xs-12">
			       <div class="col-sm-9 more-features-box">
			          <div class="more-features-box-text">
				        	...
				        	<h3 class="doctor-name"><b>Birthday: </b><?php echo $row['7'];?></h3>
				        	<h3 class="doctor-name"><b>Gender: </b><?php echo $row['6'];?></h3>
				        	<h3 class="doctor-name"><b>Contact: </b>+<?php echo $row['8'];?></h3>
				        	<h3 class="doctor-name"><b>Email: </b> <?php echo $row['5'];?></h3>
				        	<h3 class="doctor-name"><b>Region: </b> <?php echo $row['9'];?></h3>
							<h3 class="doctor-name"><b>Address: </b> <?php echo $row['10'];?></h3>
						</div>
			        </div>
			    </div>
...
<?php 
			...
			<button class="sign-up-button" onclick="Patient()">Booking history</button>
			   </div>
